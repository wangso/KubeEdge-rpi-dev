...
rm kubeedge-v1.6.0-linux-arm64.tar.gz
wget https://github.com/kubeedge/kubeedge/releases/download/v1.6.0/kubeedge-v1.6.0-linux-arm64.tar.gz || checkErr "Error downloading Kubeedge ..."
